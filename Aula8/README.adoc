...
ser recebida, por vezes não ser o ideal.
...
Crie um http://wiki.ros.org/ROS/Tutorials/CreatingPackage[novo pacote ROS] com o nome pari_aula8_ex3. oo

[TIP]
============================================
O package deve depender do _rospy_ (todos os que conteham programas python devem) e também do http://wiki.ros.org/std_msgs[_std_msgs_] e.g.:
...
[TIP]
============================================
Crie um novo pacote ROS com o nome _pari_aula8_ex4_
============================================