...
A aplicação deve ter 6 _trackbars_ que permitam alterar esses limites, e o programa deverá, quando se alteram aqueles valores, responder de imediato o resultado da segmentação usando os novos limites.
...
[TIP]
============================================
Para facilitar a deteção de cor recomenda-se a utilização de um telemóvel com o programa https://play.google.com/store/apps/details?id=com.nekobukiya.screenlight&hl=pt_PT[full screen color light] (ou semelhante) que permite colocar uma cor no ecrã do telemóvel. Por usar o ecrã do telemóvel virado para a câmara do portátil.
